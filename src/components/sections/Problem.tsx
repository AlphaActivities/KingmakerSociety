...
export default function Problem() {
  return (
    <div id="problem" className="relative bg-black overflow-hidden">
      <div className="absolute inset-0 bg-[#D11F2A]/12 pointer-events-none"></div>
      <div className="absolute inset-0 bg-gradient-to-b from-[#D11F2A]/18 via-[#D11F2A]/10 to-[#D11F2A]/18 pointer-events-none"></div>
      <div className="absolute inset-0 animate-pulse pointer-events-none" style={{ background: 'radial-gradient(ellipse 80% 60% at 50% 50%, rgba(209,31,42,0.15) 0%, transparent 70%)' }}></div>
