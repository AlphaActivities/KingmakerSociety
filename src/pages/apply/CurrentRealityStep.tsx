...
const RATINGS = Array.from({ length: 10 }, (_, i) => ({ value: String(i + 1), label: `${i + 1}` }));
            ...
            <div className="grid grid-cols-4 gap-3">
              {DAYS.map(d => (
                <button
                  ...
                  className={`py-4 px-2 rounded-xl font-bold text-base border-2 transition-colors duration-200 ${
